...
import { DiscountCodes } from './components/admin/discount-codes/discount-codes';
import { AdminCreateDiscounts } from './components/admin/admin-create-discounts/admin-create-discounts';
...
export const routes: Routes = [
    ...
    {path:'admin',component:AdminLayout,canActivate:[AuthGuard,RoleGuard],data:{roles:['Admin']},children:[
            ...
            { path: 'profile',component:Profile},
            {path:'discountcodes',component:DiscountCodes},
            {path:'create/discounts',component:AdminCreateDiscounts},
            { path: '', redirectTo: 'dashboard', pathMatch: 'full' }
        ]
    },
